			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="${pageContext.request.contextPath}/admin/sanpham/add">Thêm Sản Phẩm</a>
					</nav>
				</div>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="${i.hinhanh }" alt="">
								<div class="product-details">
									...
									<div class="prd-bottom">
										...
										<a href="/WebJDBC/admin/sanpham2/edit" class="social-info">
											<span class="lnr lnr-sync"></span>
											<p class="hover-text">compare</p>
										</a>
										
										<a href="<c:url value='/admin/sanpham/edit?id=${i.id }'/> " class="social-info">
