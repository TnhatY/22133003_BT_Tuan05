			...
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img
						src="${URL }assets/img/logo.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="${pageContext.request.contextPath}/admin/sanpham2">Shop Category</a></li>
									<li class="nav-item"><a class="nav-link"
							...
							<c:choose>
								...
								<c:otherwise>
									<a class="nav-link" href="${pageContext.request.contextPath}/views/account.jsp">${sessionScope.account.getFullName()}</a>
